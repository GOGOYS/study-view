...
public class ServiceV3 {
	 ...
	 * 
	 * (만약 My() 와 같은 코드를 만나면 My 클래스의 생설자 매서드라고 부른다.)
	 * 
	 * 여기에서는 ServiceV3() 생성자 메서드를 코드로 선언할 것이다.
	 * 생성자 method에 intKor 배열을 생성하는 코드를 추가한다.
	 * 
	 * 생성자 method는 클래스를 사용하여 인스턴스를 사용할때 
	 * 반드시 의무적으로 호출해야하는 매서드 이다.
	 * 이 매서드에 배열을 생성하는 코드를 추가하면
