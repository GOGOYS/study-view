...
public class StudentVO {
	...
	/*
	 * VO클래스에 기본 생정자와 모든 인스턴스 변수(클래스 영역의 변수)를 매개변수로 받아
	 * 초기화하는 임의생성자를 만든다.
	 * 
	 * JDK를 사용하여 프로젝트를 수행할때 다양한 도구를 연결할 필요가 있는데
	 * 도구들마다 VO객체에 접근하는 방법이 조금씩 다르다.
	 * 
	 * 어떤 도구는 getter, setter를 통해여 접근하기도 하고, 어떤 도구는 필드 생성자를 통하여
	 * 접근하기도 한다.
	 * 
	 * 최근에는 getter, setter를 만들지 말자라는 의견들이 있지만,
	 * 다양한 JDK도구를 사용할때는 필요하기도 하므로, 
	 * 표준 java 코딩의 VO클래스 작성 패턴에서는 모든 변수는 private으로
	 * 선언하고 getter, setter를 정의해 준다.
	 */
	public StudentVO() {
